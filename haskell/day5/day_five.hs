...
run l i
    ...
    | (l !! i) == 3 = run (changeValAt (l !! (i+1)) 1 l) (i+4)
    | (l !! i) == 4 = run l (i+2)
    -- TODO: The rest of this...
    | otherwise = run l (i+1)
    where 
        opcode  = (splitNumber (i)) !! 0
        a_param = (splitNumber (i)) !! 1
        b_param = (splitNumber (i)) !! 2

check_one l = [x | x <- [0..99], (run (changeValAt 2 x l) 0) !! 0 == 19690720]
check_two l = filter (\x -> check_one (changeValAt 1 x l) /= []) [0..99]

splitNumber n = [(n `mod` 100), ((n `mod` 1000) - ((n `mod` 100))) `div` 100, ((n `mod` 10000) - (((n `mod` 1000) - ((n `mod` 100))) `div` 100)) `div` 1000, 0]
